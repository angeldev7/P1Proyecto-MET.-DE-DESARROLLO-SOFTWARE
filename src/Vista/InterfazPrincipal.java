...
public class InterfazPrincipal extends JFrame {
    ...
    /**
     * Crea la barra de menú con todas las opciones del sistema
     */
    ...
    JMenuItem itemRespaldo = new JMenuItem("Generar Respaldo Anual");
        itemRespaldo.setToolTipText("Crea una copia de seguridad de todas las transacciones del año");
        itemRespaldo.addActionListener(e -> generarRespaldo());
    ...
    /**
     * Crea el panel de formulario para registrar transacciones
     */
    private JPanel crearPanelFormulario() {
        ...
        txtFecha.setFont(fieldFont);
        estilizarCampoTexto(txtFecha);
        panel.add(txtFecha, gbcFechaField);
        
        GridBagConstraints gbcTipoLabel = new GridBagConstraints();
        gbcTipoLabel.gridx = 2; gbcTipoLabel.gridy = 0;
        ...
        panel.add(lblTipo, gbcTipoLabel);
        
        GridBagConstraints gbcTipoField = new GridBagConstraints();
        gbcTipoField.gridx = 3; gbcTipoField.gridy = 0;
        ...
        cmbTipoDocumento = new JComboBox<>(new String[]{"Factura", "Gasto"});
        cmbTipoDocumento.setFont(fieldFont);
        cmbTipoDocumento.addActionListener(e -> actualizarCamposSegunTipo());
        panel.add(cmbTipoDocumento, gbcTipoField);
        
        // Fila 2: Proveedor/Cliente y Monto
        GridBagConstraints gbcProveedorLabel = new GridBagConstraints();
        gbcProveedorLabel.gridx = 0; gbcProveedorLabel.gridy = 1;
        gbcProveedorLabel.insets = new Insets(8, 8, 8, 8);
        gbcProveedorLabel.anchor = GridBagConstraints.EAST;
        JLabel lblProveedor = new JLabel("Proveedor/Cliente:");
        lblProveedor.setFont(labelFont);
        panel.add(lblProveedor, gbcProveedorLabel);
        
        GridBagConstraints gbcProveedorField = new GridBagConstraints();
        gbcProveedorField.gridx = 1; gbcProveedorField.gridy = 1;
        gbcProveedorField.insets = new Insets(8, 8, 8, 8);
        gbcProveedorField.anchor = GridBagConstraints.WEST;
        gbcProveedorField.fill = GridBagConstraints.HORIZONTAL;
        txtProveedorCliente = new JTextField();
        txtProveedorCliente.setFont(fieldFont);
        estilizarCampoTexto(txtProveedorCliente);
        panel.add(txtProveedorCliente, gbcProveedorField);
        
        GridBagConstraints gbcMontoLabel = new GridBagConstraints();
        gbcMontoLabel.gridx = 2; gbcMontoLabel.gridy = 1;
        gbcMontoLabel.insets = new Insets(8, 8, 8, 8);
        gbcMontoLabel.anchor = GridBagConstraints.EAST;
        JLabel lblMonto = new JLabel("Monto (USD):");
        lblMonto.setFont(labelFont);
        panel.add(lblMonto, gbcMontoLabel);
        
        GridBagConstraints gbcMontoField = new GridBagConstraints();
        gbcMontoField.gridx = 3; gbcMontoField.gridy = 1;
        gbcMontoField.insets = new Insets(8, 8, 8, 8);
        gbcMontoField.anchor = GridBagConstraints.WEST;
        gbcMontoField.fill = GridBagConstraints.HORIZONTAL;
        txtMonto = new JTextField();
        txtMonto.setFont(fieldFont);
        estilizarCampoTexto(txtMonto);
        panel.add(txtMonto, gbcMontoField);
        
        // Fila 3: Cuenta Contable y Número de Documento
        GridBagConstraints gbcCuentaLabel = new GridBagConstraints();
        gbcCuentaLabel.gridx = 0; gbcCuentaLabel.gridy = 2;
        gbcCuentaLabel.insets = new Insets(8, 8, 8, 8);
        gbcCuentaLabel.anchor = GridBagConstraints.EAST;
        JLabel lblCuenta = new JLabel("Cuenta Contable:");
        lblCuenta.setFont(labelFont);
        panel.add(lblCuenta, gbcCuentaLabel);
        
        GridBagConstraints gbcCuentaField = new GridBagConstraints();
        gbcCuentaField.gridx = 1; gbcCuentaField.gridy = 2;
        gbcCuentaField.insets = new Insets(8, 8, 8, 8);
        gbcCuentaField.anchor = GridBagConstraints.WEST;
        gbcCuentaField.fill = GridBagConstraints.HORIZONTAL;
        txtCuentaContable = new JTextField();
        txtCuentaContable.setFont(fieldFont);
        estilizarCampoTexto(txtCuentaContable);
        panel.add(txtCuentaContable, gbcCuentaField);
        
        GridBagConstraints gbcNumDocLabel = new GridBagConstraints();
        gbcNumDocLabel.gridx = 2; gbcNumDocLabel.gridy = 2;
        gbcNumDocLabel.insets = new Insets(8, 8, 8, 8);
        gbcNumDocLabel.anchor = GridBagConstraints.EAST;
        JLabel lblNumDoc = new JLabel("Nº Documento:");
        lblNumDoc.setFont(labelFont);
        panel.add(lblNumDoc, gbcNumDocLabel);
        
        GridBagConstraints gbcNumDocField = new GridBagConstraints();
        gbcNumDocField.gridx = 3; gbcNumDocField.gridy = 2;
        gbcNumDocField.insets = new Insets(8, 8, 8, 8);
        gbcNumDocField.anchor = GridBagConstraints.WEST;
        gbcNumDocField.fill = GridBagConstraints.HORIZONTAL;
        txtNumeroDocumento = new JTextField();
        txtNumeroDocumento.setFont(fieldFont);
        estilizarCampoTexto(txtNumeroDocumento);
        panel.add(txtNumeroDocumento, gbcNumDocField);
        
        // Fila 4: Descripción
        GridBagConstraints gbcDescLabel = new GridBagConstraints();
        gbcDescLabel.gridx = 0; gbcDescLabel.gridy = 3;
        gbcDescLabel.insets = new Insets(8, 8, 8, 8);
        gbcDescLabel.anchor = GridBagConstraints.NORTHEAST;
        JLabel lblDesc = new JLabel("Descripción:");
        lblDesc.setFont(labelFont);
        panel.add(lblDesc, gbcDescLabel);
        
        GridBagConstraints gbcDescField = new GridBagConstraints();
        gbcDescField.gridx = 1; gbcDescField.gridy = 3;
        gbcDescField.gridwidth = 2;
        gbcDescField.insets = new Insets(8, 8, 8, 8);
        ...
        panel.add(scrollDesc, gbcDescField);
        
        // Fila 4: Checkbox Deducible
        GridBagConstraints gbcCheckbox = new GridBagConstraints();
        gbcCheckbox.gridx = 3; gbcCheckbox.gridy = 3;
        gbcCheckbox.insets = new Insets(8, 8, 8, 8);
        gbcCheckbox.anchor = GridBagConstraints.WEST;
        chkDeducible = new JCheckBox("Gasto Deducible de Impuestos");
        chkDeducible.setFont(new Font("Arial", Font.PLAIN, 11));
        chkDeducible.setBackground(Color.WHITE);
        chkDeducible.setEnabled(false);
        panel.add(chkDeducible, gbcCheckbox);
        
        // Fila 5: Botones
        GridBagConstraints gbcBotones = new GridBagConstraints();
        gbcBotones.gridx = 0; gbcBotones.gridy = 4;
        gbcBotones.gridwidth = 4;
        gbcBotones.insets = new Insets(15, 8, 8, 8);
        gbcBotones.anchor = GridBagConstraints.CENTER;
        
        JPanel panelBotones = new JPanel(new FlowLayout(FlowLayout.CENTER, 15, 5));
        panelBotones.setOpaque(false);
        
        // CREAR BOTONES DIRECTAMENTE (sin método crearBoton)
        ...
        btnRegistrar.addActionListener(e -> registrarTransaccion());
        
        JButton btnLimpiar = new JButton("Limpiar Formulario");
        btnLimpiar.setFont(new Font("Arial", Font.BOLD, 12));
        btnLimpiar.setBackground(COLOR_ADVERTENCIA);
        btnLimpiar.setForeground(Color.WHITE);
        btnLimpiar.setFocusPainted(false);
        btnLimpiar.setBorderPainted(false);
        btnLimpiar.setPreferredSize(new Dimension(200, 35));
        btnLimpiar.addActionListener(e -> limpiarFormulario());
        
        JButton btnActualizar = new JButton("Actualizar Tabla");
        btnActualizar.setFont(new Font("Arial", Font.BOLD, 12));
        btnActualizar.setBackground(COLOR_SECUNDARIO);
    ...
    private void aprobarTransaccion() {
        ...
        // Aprobar transacción
        if (controladorTransaccion.aprobarTransaccion(id, usuario)) {
    ...
    /**
     * Genera un respaldo de las transacciones en formato JSON legible
     */
    private void generarRespaldo() {
        String anio = JOptionPane.showInputDialog(this, 
            "Ingrese el año para generar respaldo:", "2025");
        ...
        try {
            ...
            // Filtrar transacciones del año especificado
            java.util.List<Transaccion> transaccionesAnio = controladorTransaccion.getTransaccionesActivas()
                .stream()
                .filter(t -> t.getFecha().getYear() == anioInt)
                .collect(java.util.stream.Collectors.toList());
            
            if (transaccionesAnio.isEmpty()) {
                mostrarAdvertencia("No se encontraron transacciones para el año " + anio + "\n\n" +
                                 "El respaldo no será generado.");
                return;
            }
            
            // Generar nombre de archivo con timestamp
            String timestamp = LocalDate.now().format(DateTimeFormatter.ofPattern("yyyyMMdd"));
            String nombreArchivo = "respaldo_transacciones_" + anio + "_" + timestamp + ".json";
            String rutaArchivo = System.getProperty("user.dir") + "\\" + nombreArchivo;
            
            // Crear objeto con información del respaldo
            com.google.gson.JsonObject respaldo = new com.google.gson.JsonObject();
            respaldo.addProperty("fechaRespaldo", LocalDate.now().toString());
            respaldo.addProperty("anio", anioInt);
            respaldo.addProperty("totalTransacciones", transaccionesAnio.size());
            respaldo.addProperty("generadoPor", controladorUsuario.getUsuarioActual().getNombreUsuario());
            respaldo.addProperty("empresa", "Comercial el mejor vendedor S.A.");
            
            // Calcular estadísticas
            long facturas = transaccionesAnio.stream()
                .filter(t -> t.getTipoDocumento().equals("Factura")).count();
            long gastos = transaccionesAnio.stream()
                .filter(t -> t.getTipoDocumento().equals("Gasto")).count();
            double totalFacturas = transaccionesAnio.stream()
                .filter(t -> t.getTipoDocumento().equals("Factura"))
                .mapToDouble(Transaccion::getMonto).sum();
            double totalGastos = transaccionesAnio.stream()
                .filter(t -> t.getTipoDocumento().equals("Gasto"))
                .mapToDouble(Transaccion::getMonto).sum();
            
            com.google.gson.JsonObject estadisticas = new com.google.gson.JsonObject();
            estadisticas.addProperty("totalFacturas", facturas);
            estadisticas.addProperty("totalGastos", gastos);
            estadisticas.addProperty("montoFacturas", totalFacturas);
            estadisticas.addProperty("montoGastos", totalGastos);
            estadisticas.addProperty("balanceNeto", totalFacturas - totalGastos);
            
            respaldo.add("estadisticas", estadisticas);
            
            // Convertir transacciones a JSON
            com.google.gson.JsonArray transaccionesJson = new com.google.gson.JsonArray();
            for (Transaccion t : transaccionesAnio) {
                com.google.gson.JsonObject trans = new com.google.gson.JsonObject();
                trans.addProperty("id", t.getIdTransaccion());
                trans.addProperty("fecha", t.getFecha().toString());
                trans.addProperty("tipo", t.getTipoDocumento());
                trans.addProperty("proveedorCliente", t.getProveedorCliente());
                trans.addProperty("monto", t.getMonto());
                trans.addProperty("cuentaContable", t.getCuentaContable());
                trans.addProperty("numeroDocumento", t.getNumeroDocumento());
                trans.addProperty("estado", t.getEstado());
                trans.addProperty("usuarioRegistro", t.getUsuarioRegistro().getNombreUsuario());
                transaccionesJson.add(trans);
            }
            
            respaldo.add("transacciones", transaccionesJson);
            
            // Escribir archivo JSON con formato legible (pretty print)
            com.google.gson.Gson gson = new com.google.gson.GsonBuilder()
                .setPrettyPrinting()
                .create();
            
            java.io.FileWriter writer = new java.io.FileWriter(rutaArchivo);
            gson.toJson(respaldo, writer);
            writer.close();
            ...
            String mensaje = String.format(
                ...
                "💰 Balance: $%,.2f\n\n" +
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n" +
                "ℹ️ El archivo está en formato JSON legible.\n" +
                "Puede abrirlo con cualquier editor de texto.",
                nombreArchivo,
                rutaArchivo,
            ...
            controladorBitacora.registrar(controladorUsuario.getUsuarioActual(), 
                "GENERAR_RESPALDO", 
                "Respaldo año " + anio + " - " + transaccionesAnio.size() + " transacciones");
            
        } catch (NumberFormatException ex) {
            mostrarError("❌ Año inválido\n\nPor favor ingrese un año válido.\nEjemplo: 2025");
        } catch (Exception ex) {
            mostrarError("❌ Error al generar el respaldo:\n\n" + ex.getMessage() + 
                       "\n\nContacte al administrador del sistema.");
            ex.printStackTrace();
        }
    }
    ...
    /**
     * Rechaza una transacción seleccionada (solo Jefatura)
     */
    /**
    ...
    private void mostrarDetalleTransaccion() {
        ...
        Transaccion t = controladorTransaccion.getTransaccionesActivas().stream()
            .filter(trans -> trans.getIdTransaccion() == id)
            .findFirst()
            .orElse(null);
    ...
    private void crearBarraMenu() {
        ...
        itemRespaldo.setToolTipText("Crea una copia de seguridad de todas las transacciones del año");
        itemRespaldo.addActionListener(e -> generarRespaldo());
        itemRespaldo.setEnabled(esJefatura); // Solo jefatura puede generar respaldos
